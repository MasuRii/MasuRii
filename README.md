...
<p align="center">
  <a href="https://github.com/MasuRii">
    <img src="https://img.shields.io/badge/Total%20Stars-1097-facc15?style=social&logo=github" alt="Total GitHub stars" />
  </a>
  &nbsp;&nbsp;
...
- 🧰 **[pi-tool-display](https://github.com/MasuRii/pi-tool-display)** - OpenCode-style tool output rendering for Pi coding agent (Pi extension, TUI, MCP-aware, RTK-aware). `⭐ 291`
- 🔐 **[pi-permission-system](https://github.com/MasuRii/pi-permission-system)** - Permission enforcement extension for the Pi coding agent. `⭐ 166`
...
- ⚡ **[pi-rtk-optimizer](https://github.com/MasuRii/pi-rtk-optimizer)** - Pi extension for RTK command rewriting and tool-output compaction optimization. `⭐ 273`
